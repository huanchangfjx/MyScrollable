package com.brcorner.myscrollable;
...
import com.brcorner.scrolllib.CanScrollVerticallyDelegate;
import com.brcorner.scrolllib.OnScrollChangedListener;
import com.brcorner.scrolllib.ScrollableLayout;
...
public class ScrollableDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle sis) {
        ...
        scrollableLayout.setFriction(getArguments().getFloat(ARG_FRICTION, 0));
